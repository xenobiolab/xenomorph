...
kmer_model_input_file = '/home/marchandlab/Dev/xenomorph-xemora/models/libv2/Zn_r9.4.1.csv'
kmers = pd.read_csv(kmer_model_input_file)

#Set an output model path
output_file_path ='/home/marchandlab/Dev/xenomorph-xemora/models/libv2/Zn_r9.4.1.csv'
