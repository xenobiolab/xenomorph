...
kmer_model_input_file = '/home/marchandlab/Dev/xenomorph-xemora/xx-test/PZa_r10.4.1_Model_Building/PZa_Model_Building_FLG114_summary.csv'
kmers = pd.read_csv(kmer_model_input_file)

#Set an output model path
output_file_path ='/home/marchandlab/Dev/xenomorph-xemora/models/10.4.1/Za_r10.4.1.csv'
